...
with lib; {
  ...
  in
    mkIf config.common.librewolf.enable {
      home.file = {
        ".librewolf/librewolf.overrides.cfg".target = "${configHome}/librewolf/librewolf/librewolf.overrides.cfg";
        ".librewolf/native-messaging-hosts/.keep".enable = false;
        ".mozilla/native-messaging-hosts/.keep".enable = false;
